...
def closest_vertex(vertices: np.array, point: np.array) -> Tuple[int, np.array]:
    assert vertices.shape[1] == point.shape[1], "vertice has more coordinate than point"
...
def location_to_camera_view(location: np.array, intrinsic_matrix, inv_extrinsic_matrix):
